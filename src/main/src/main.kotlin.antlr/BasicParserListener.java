...
public interface BasicParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code AssigR_Exp}
	 * labeled alternative in {@link BasicParser#assignRHS}.
	 * @param ctx the parse tree
	 */
	void enterAssigR_Exp(BasicParser.AssigR_ExpContext ctx);
	/**
	 * Exit a parse tree produced by the {@code AssigR_Exp}
	 * labeled alternative in {@link BasicParser#assignRHS}.
	 * @param ctx the parse tree
	 */
	void exitAssigR_Exp(BasicParser.AssigR_ExpContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code AssigR_Pair}
	 * labeled alternative in {@link BasicParser#assignRHS}.
	 * @param ctx the parse tree
	 */
	void enterAssigR_Pair(BasicParser.AssigR_PairContext ctx);
	/**
	 * Exit a parse tree produced by the {@code AssigR_Pair}
	 * labeled alternative in {@link BasicParser#assignRHS}.
	 * @param ctx the parse tree
	 */
	void exitAssigR_Pair(BasicParser.AssigR_PairContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code BinOper}
	 * labeled alternative in {@link BasicParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterBinOper(BasicParser.BinOperContext ctx);
	/**
	 * Exit a parse tree produced by the {@code BinOper}
	 * labeled alternative in {@link BasicParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitBinOper(BasicParser.BinOperContext ctx);
	/**
